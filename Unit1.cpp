...
TForm1 *Form1;
    ...
    {
        if(ball->Left <= background->Left+ball->Width-20)
        {
            leftPlayerCounter++;
            return true;
        }
    ...
    {
        if(ball->Left+ball->Width >= background->Width+ball->Width-20)
        {
            rightPlayerCounter++;
            return true;
        }
      ...
      TShiftState Shift)
{
    ...
    if(Key == VK_ADD)
    {
        ...
        moveLeftPaddleUp->Interval=10;
        moveLeftPaddleDown->Interval=10;
        moveRightPaddleUp->Interval=10;
        moveRightPaddleDown->Interval=10;
    }
}
//---------------------------------------------------------------------------
//---------------------------------------------------------------------------
